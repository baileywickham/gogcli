...
// readConfigForAuth is used by auth commands that need to inspect the
// token_endpoint configuration (e.g. auth status, auth list --check).
var readConfigForAuth = config.ReadConfig
